...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const serviceId = 'service_t10ktli'
        const contactTemplateId = 'template_4wckslr' // to YOU
        const autoReplyTemplateId = 'template_vltgghq' // to VISITOR
        const publicKey = 'tA-itJctjmwxVSAi6'

        // Params for "Contact Us" email (to you)
        const contactParams = {
            from_name: name,
            from_email: email,
            message: message,
        ...
        // Params for "Auto-Reply" email (to visitor)
