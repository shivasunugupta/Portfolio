            ...
            <div className='max-w-7xl mx-auto px-4'>
                <div className='flex justify-between items-center h-16'>
                    ...
                    <div className='hidden md:flex items-center space-x-8'>
                        ...
                        <Button variant='ghost' onClick={() => scrollToSection("others")} className='px-4 py-2 text-slate-600 dark:text-slate-200 cursor-pointer'>
                            Others
                        </Button>
                        ...
                        <Button variant='ghost' className='relative cursor-pointer rounded-md'>
                            ...
                            <a href="https://drive.google.com/drive/folders/1S_05Q26DP8Xhgv2_xAXBRPXPQzs8z4ya?usp=drive_link" target="__blacnk">Resume</a>
                        </Button>
                    </div>
                    {/* mobile view button  */}
                ...
                {isMenuOpen && (
                    <div className='md:hidden py-4 border-t border-slate-200'>
                        <div className='flex flex-col space-y-2'>
                            ...
                            <Button variant='secondary' onClick={() => scrollToSection("others")} className='text-left px-4 py-2 cursor-pointer'>
                                Others
                            </Button>
                            ...
                            <Button variant='secondary' className='relative text-left px-4 py-2 cursor-pointer'>
                                ...
                                <a href="https://drive.google.com/drive/folders/1S_05Q26DP8Xhgv2_xAXBRPXPQzs8z4ya?usp=drive_link" target="__blank">Resume</a>
                            </Button>
                        </div>
                    </div>
                )}
